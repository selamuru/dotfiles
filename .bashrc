...
# Prompt
export PS1='\[\e[0;31m\]♥  \[\e[1;36m\]\D{%T} `if [ $? = 0 ]; then echo "\[\e[0;32m\]✔"; else echo "\[\e[0;31m\]✘"; fi` \[\e[00;37m\]\u\[\e[01;37m\]:$(unalias git; __git_ps1 "\[$red\][\[$green\]%s\[$red\]]\[$reset\]""%s\[\e[00m\]")\[\e[01;34m\]\w\n\[\e[00m\]\$ '
